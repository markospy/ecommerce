...
export function Navbar({ price, setPrice, setProduct, handleClick}:
  ...
  return (
    <div className="flex h-fit w-full">
		<img src="/shopee.svg" alt="Logo de la tienda" className="size-24 w-1/12 pt-6" />

		<div className="w-10/12 flex-col gap-4 pt-6">
			<div className="mb-4 flex w-11/12 justify-center">
			...
			<div className="flex w-11/12 justify-center gap-2 bg-transparent">
