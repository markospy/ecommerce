    ...
    <div className="flex h-fit w-full flex-col items-center justify-center gap-2">
			<div className="flex h-1/2 w-10/12 items-center justify-start pt-6">
				...
				<div className="flex w-11/12 justify-center">
					<div className="relative flex  w-1/2">
						...
						/>
						<IcOutlineSearch className="absolute right-0 h-10 w-14 cursor-pointer rounded-r-md bg-orange-500 p-2 text-gray-900" onClick={() =>  setProduct(refSearch.current)}/>
					</div>
				</div>
			</div>
			...
			<div className="flex w-full items-center justify-center gap-2 bg-transparent">
				...
				<div className="relative flex size-fit">
					...
					<IcOutlineSearch className="absolute -right-6 h-7 w-14 cursor-pointer rounded-r-md bg-orange-500 p-1 text-gray-900" onClick={() =>  setProduct(refSearch.current)}/>
				</div>
			</div>
    </div>
  );
